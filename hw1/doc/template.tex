...
\begin{minipage}{\textwidth}
	\begin{minipage}{0.49\textwidth}
		...
		\end{tikzpicture}
		\captionsetup{width=.9\textwidth}
		\captionof{figure}{Mean Average Precision comparision among different features in different grid levels with level 1 best configurations}
	 \end{minipage}
	 \hfill
	\begin{minipage}{0.49\textwidth}
		\centering
		...
		\end{tabular}
		\captionsetup{width=.8\textwidth}
		\captionof{table}{Mean Average Precision comparision table of different features with different grid levels with their level 1 best configurations}
	\end{minipage}
\end{minipage}
